package com.xgf.transaction.xml;

import com.xgf.transaction.xml.controller.BookController;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context =
                new ClassPathXmlApplicationContext("com/xgf//transaction/xml/applicationContext.xml");
